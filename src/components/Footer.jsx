  ...
  return (
    <div> <hr />
      <footer className="footer p-10  text-base-content">
        <nav>
          <h6 className="footer-title">E-Book</h6>
          <a className="link link-hover">Manga</a>
          <a className="link link-hover">Online Reading</a>
          <a className="link link-hover">Purchase Options</a>
          <a className="link link-hover">Educational Resources</a>
        </nav>
        <nav>
          <h6 className="footer-title">Top Reads</h6>
      ...
      <footer className="footer px-10 py-4 border-t bg-base-200 text-base-content border-base-300">
        <aside className="items-center grid-flow-col">
          ...
          <p>Top Reads. <br />Providing reliable Reasources since 2024</p>
        </aside>
